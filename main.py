...
if file_upload is not None:
    ...
    # temp_file = r"RNC_-_Painel_de_Acompanhamento_1729531707.xlsx"
    ...
    ws['G8'] = responsavel
    ws['G15'] = responsavel2
    ws['A12'] = 'N/A' if pd.isna(descricao) else descricao
    ws['A17'] = 'N/A' if pd.isna(acao_imediata) else acao_imediata
    ws['B24'] = maquina
    ws['B25'] = mao_de_obra
    ...
    ws['G7'] = 'N/A' if pd.isna(status) else status
    ws['I8'] = data
    ws['I14'] = data2
    ws['I22'] = data3etapa
    ws['A58'] = conclusao
    ...
    ws['G9'] = item_norma
    ws['G14'] = 'N/A' if pd.isna(status2) else status2
